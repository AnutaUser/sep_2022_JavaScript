...
// }
//
// users.map(user => addressArr.push(user.address));
//
...
//         <div>Address: ${user.address.country} -- ${user.address.street} -- ${user.address.houseNumber}</div>
//         <hr>
//     `;
//     document.body.appendChild(userDiv);
// }
...
// const divById = document.getElementById('content');
//
